                    ...
                    <form class="needs-validation" novalidate method="post" action="{{ route('backend.users.update', $user->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-b-10">
                                ...
                                <input type="text" class="form-control" value="{{ $user['name']??"" }}" name="username" placeholder="Name" aria-describedby="inputGroupPrepend" required>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-b-10">
                                ...
                                <input type="date" class="form-control" value="{{ $user['birthday']??"" }}" name="birthday" placeholder="Birthday" aria-describedby="inputGroupPrepend" required>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-b-10">
